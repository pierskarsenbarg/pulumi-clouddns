...
namespace PiersKarsenbarg.Clouddns
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("PiersKarsenbarg.Clouddns.version.txt");
    ...
    internal sealed class ClouddnsResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ClouddnsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
